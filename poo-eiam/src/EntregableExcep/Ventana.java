...
public class Ventana extends javax.swing.JFrame {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(TEdad, javax.swing.GroupLayout.PREFERRED_SIZE, 88, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(121, 121, 121)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int No_Cuenta = Integer.parseInt(TCuenta.getText());
        int Edad = Integer.parseInt(TEdad.getText());
        
        Alumno alumno = new Alumno();
        
        try {
            ValidacionEdad.EdadException(Edad);
        } catch (EdadException ex) {
            JOptionPane.showMessageDialog(this,ex.getMessage());
        }
        alumno.setNombre(Nombre);
        alumno.setNo_cuenta(No_Cuenta);
        alumno.setEdad(Edad);
